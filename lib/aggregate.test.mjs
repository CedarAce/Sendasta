...
const rows = [
  ...
  { at: NOW, action: "page_view", ip: "1.1.1.1", path: "/pricing", country: "US", city: "New York", user_agent: "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36" }, // same visitor
