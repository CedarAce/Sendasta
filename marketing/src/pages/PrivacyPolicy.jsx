/*
  IMPORTANT: This is a placeholder Privacy Policy.
  Before publishing, replace this page with a proper policy generated by
  Termly (https://termly.io) or Iubenda (https://iubenda.com) for Sendasta.
  Replace all [BRACKET] tokens with your actual information.
  This process takes approximately 20 minutes and is required before
    ...
    <main className="pt-16 bg-white">
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-10 text-sm text-yellow-800">
          <strong>Note:</strong> This is a placeholder Privacy Policy. Replace with a proper policy from
        ...
        <Section title="4. Data Storage and Security">
          <p>
            Policy configurations for Enterprise accounts are stored on servers located in [REGION — e.g., United States].
        ...
        <Section title="5. Data Retention">
          <p>
            ...
            obligations. Contact form submissions are retained for [X months/years]. Enterprise account data is
            retained for the duration of the subscription plus [X years] following termination.
          </p>
        </Section>
